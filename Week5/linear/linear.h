...
class LinearRegression{
    private:
        ...
        uint64_t max_iterations; // To ensure the algorithm terminates in finite time in case convergence is not achieved
        vector<double> train_loss; // After each iteration of gradient descent stores the loss from the train data
